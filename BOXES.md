...
| `regdump`, `regwatch`, `snap*`, `irscan`, `irkeys`, `irtest` | works | shared, untested (register ranges from the IPTV box) |
...
| NCAPPS: `launcher/`, `apps/`, `doom/`, `sdk/` | works | need AV init + boot script for this box |
