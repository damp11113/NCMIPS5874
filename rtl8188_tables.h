...
/*
 * RTL8188F init tables, copied verbatim from Linux
 * drivers/net/wireless/realtek/rtl8xxxu/8188f.c (GPL-2.0-only,
 * Copyright (c) 2022 Bitterblue Smith, portions (c) Jes Sorensen and
 * Realtek). Each table ends with an 0xffff (reg) / 0xff (rf reg) marker.
 */
#ifndef RTL8188_TABLES_H
#define RTL8188_TABLES_H
...
static const struct rtl_reg8val rtl8188f_mac_init_table[] = {
...
static const struct rtl_reg32val rtl8188fu_phy_init_table[] = {
...
static const struct rtl_reg32val rtl8188f_agc_table[] = {
...
static const struct rtl_rfregval rtl8188fu_radioa_init_table[] = {
...
static const struct rtl_rfregval rtl8188fu_cut_b_radioa_init_table[] = {
    {0x00, 0x00030000}, {0x08, 0x00008400},
    {0x18, 0x00000407}, {0x19, 0x00000012},
    {0x1B, 0x00001C6C},
    {0x1E, 0x00080009}, {0x1F, 0x00000880},
